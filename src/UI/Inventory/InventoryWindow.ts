...
class InventoryWindow extends Window {
    ...
    public InitElements(): void {
        ...
        this.CreateBorder();
        let Head: any = this.AddElement(new Engineer.Vertex(220, 80, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        this.Data["HeadSlot"] = Head;
        Head.Data["Slot"] = true;
        Head.Data["SlotType"] = "Head";
        Head.Events.MouseUp.push(this.SlotMouseUp.bind(this));
        let Weapon: any = this.AddElement(new Engineer.Vertex(120, 170, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        ...
        let OffHand = this.AddElement(new Engineer.Vertex(320, 170, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        ...
        let Chest = this.AddElement(new Engineer.Vertex(220, 170, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        ...
        let Gloves = this.AddElement(new Engineer.Vertex(120, 260, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        ...
        let Greaves = this.AddElement(new Engineer.Vertex(220, 260, 2.5), new Engineer.Vertex(70, 70, 1), 0);
        ...
        let Boots = this.AddElement(new Engineer.Vertex(220, 350, 2.5), new Engineer.Vertex(70, 70, 1), 0);
