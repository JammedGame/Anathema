...
{   
    ...
    public get Direction():any { return new TBX.Vertex(this._Target.X - this._Collider.Trans.Translation.X, this._Target.Y - this._Collider.Trans.Translation.Y, 0); }
    ...
    public Apply(Scene:GameScene) : boolean
    {
        ...
        let Movement = new TBX.Vertex(this._Target.X - this._Collider.Trans.Translation.X, this._Target.Y - this._Collider.Trans.Translation.Y, 0);
        ...
        if(TBX.Vertex.Distance(this._Collider.Trans.Translation, this._Target) < 5) return false;
        return true;
    }
}
