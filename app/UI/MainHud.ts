...
class MainHud extends Window
{
    ...
    public constructor(Scene:GameScene, PlayerActions:PlayerActions)
    {
        ...
        this._QDown = this.AddElement(new Engineer.Vertex(85,-5,2.5), new Engineer.Vertex(50,50,1), 3);
        ...
        this._WDown = this.AddElement(new Engineer.Vertex(140,-5,2.5), new Engineer.Vertex(50,50,1), 0);
        ...
        this._EDown = this.AddElement(new Engineer.Vertex(195,-5,2.5), new Engineer.Vertex(50,50,1), 0);
        ...
        this._RDown = this.AddElement(new Engineer.Vertex(250,-5,2.5), new Engineer.Vertex(50,50,1), 0);
        ...
        this._RightClick = this.AddElement(new Engineer.Vertex(325,10,2.5), new Engineer.Vertex(80,80,1), 2);
        ...
        this.AddElement(new Engineer.Vertex(85,38,2.5), new Engineer.Vertex(50,30,1), 0, Engineer.Color.FromRGBA(180,180,180,255));
        this._InventoryButton = this.AddElement(new Engineer.Vertex(140,38,2.5), new Engineer.Vertex(50,30,1), 1, Engineer.Color.FromRGBA(180,180,180,255));
        this._InventoryButton.Events.MouseDown.push(this.InventoryButtonInvoke.bind(this));
        this._InventoryButtonClick = [];
        this.AddElement(new Engineer.Vertex(195,38,2.5), new Engineer.Vertex(50,30,1), 2, Engineer.Color.FromRGBA(180,180,180,255));
        this.AddElement(new Engineer.Vertex(250,38,2.5), new Engineer.Vertex(50,30,1), 3, Engineer.Color.FromRGBA(180,180,180,255));
        this.CreateBorder();
        this.Update();
        this.Init();
    }
