...
class Item extends Engineer.Engine.Tile
{
    ...
    public constructor(Player:Player, Scene:GameScene, ItemName:string, posX:number, posY:number, inInv:boolean=true)
    {
        super();
        ...
        this.Trans.Translation = new Engineer.Math.Vertex(posX,posY, 0.5);
        this.Data["Item"] = true;
