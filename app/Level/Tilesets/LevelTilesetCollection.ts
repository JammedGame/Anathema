...
class LevelTilesetCollection
{
    ...
    public constructor()
    {
        ...
        this.Items["Town"] = new LevelTileset("Town", LevelTilesetLayoutType.Bordered, LevelTilesetFloorType.Uniform, LevelTilesetWallType.Bordered, LevelTilesetCeilingType.Roofed, [1,6]);
    }
